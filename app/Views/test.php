    ...
    <form id="test-form" action="<?= base_url('test/process_test');?>" method="post">
        <div class="container-fluid" style="padding-bottom: 54px">
            <div class="topic-1 m-4" style="">
                ...
                <div class="row question-1 mt-4" style="">
                    <div class="col-12 question-title mb-1">
                        1. Sarah asked me, “What would you __________ if you were in my shoes?”
                    </div>
                    
                    <div class="col-12 answer mb-1 mb-1">
                ...
                <div class="row question-3 mt-4" style="display:none;">
                    <div class="col-12 question-title mb-1">
                ...
                <div class="row question-4 mt-4" style="display:none;">
                    <div class="col-12 question-title mb-1">
                ...
                <div class="row question-5 mt-4" style="display:none;">
                    <div class="col-12 question-title mb-1">
                ...
                <div class="row question-6 mt-4" style="display:none;">
                    <div class="col-12 question-title mb-1">
                ...
                <div class="row question-7 mt-4" style="display:none;">
                    <div class="col-12 question-title mb-1">
                ...
                <div class="row question-8 mt-4" style="display:none;">
                    <div class="col-12 question-title mb-1">
                ...
                <div class="row question-9 mt-4" style="display:none;">
                    <div class="col-12 question-title mb-1">
            ...
            <div class="topic-2 m-4" style="display:none;">
                <div class="row">
                    <div class="col-12 header">
                ...
                <div class="row question-10 mt-4">
                    <div class="col-12 question-title mb-1">
                ...
                <div class="row question-11 mt-4" style="display:none;">
                    <div class="col-12 question-title mb-1">
                ...
                <div class="row question-12 mt-4" style="display:none;">
                    <div class="col-12 question-title mb-1">
                ...
                <div class="row question-13 mt-4" style="display:none;">
                    <div class="col-12 question-title mb-1">
                ...
                <div class="row question-14 mt-4" style="display:none;">
                    <div class="col-12 question-title mb-1">
                ...
                <div class="row question-15 mt-4" style="display:none;">
                    <div class="col-12 question-title mb-1">
                ...
                <div class="row question-16 mt-4" style="display:none;">
                    <div class="col-12 question-title mb-1">
                ...
                <div class="row question-17 mt-4" style="display:none;">
                    <div class="col-12 question-title mb-1">
            ...
            <div class="topic-3 m-4" style="display:none;">
                <div class="row">
                    <div class="col-12 header">
                ...
                <div class="row editing-question mt-3">
                    <h2 style="font-weight:700;">Question</h2>
                    <p class="grey">Choose the correct answer for this highlight word below</p>
                ...
                <div class="row question-18" style="display:none;">
                    <div class="col-12 question-title mb-1 mt-4">
            ...
            <div class="topic-4 m-4" style="display:none;">
                <div class="row">
                    <div class="col-12 header">
                ...
                <div class="row question-23 mt-4" style="display:none;">
                ...
                <div class="row question-24 mt-4" style="display:none;">
                    <div class="col-12 question-title">
                ...
                <div class="row question-25 mt-4" style="display:none;">
                    <div class="col-12 question-title">
            ...
            <div class="topic-5 m-4" style="display:none;">
                <div class="row">
                    <div class="col-12 header">
            ...
            <div class="btn btn-lg btn-prev none" onclick="prevQuestion()" style="margin-left:10px">
                Prev
            </div>
            <div class="btn btn-lg btn-next" onclick="nextQuestion()" style="float:right; margin-right:10px">
                Next
            </div>
            
            <button class="btn btn-lg submit-btn none" type="submit" style="float:right; margin-right:10px">
            </i> Submit
            </button>
        </div>
    </form>
