...
<body>
    <div class="row">
    <div class="d-flex p-2 pt-0 navbar flex-column align-items-start justify-content-center col-4" style="position:fixed;">
            <div class="ps-2 pb-4">
    ...
    <div class="container summary-section col-lg-9 col-md-8 col-sm-6">
        <div class="row">
